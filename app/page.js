...
export default function Home() {
    ...
    return (
        <>
            <GameTitle title={"柴題遊戲"} />
            <div className="flex flex-col items-center gap-6">
                <div className="flex items-center justify-center gap-4 flex-wrap">
                    <span className="font-bold text-yellow-600 text-xl mx-3">點擊遊戲選單開始遊戲</span>
                ...
                <div className="flex justify-center items-center gap-6 flex-wrap">{gameCards}</div>
            </div>
        </>
    );
}
